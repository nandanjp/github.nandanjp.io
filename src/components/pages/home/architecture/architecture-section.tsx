            ...
            <div className="flex flex-wrap gap-2.5">
                {DEPLOYED_APPS.map((app) => (
                    <motion.div
                        ...
                        className={cn(
                            'flex items-center gap-2.5 rounded-lg border-2 border-dashed px-3 py-2 cursor-default',
                            app.bg,
                            app.border,
                        )}
                    >
...
function ArchitectureDiagram() {
    return (
        ...
        >
            ...
            <rect
                x="8" y="108" width="384" height="288"
                rx="10" ry="10"
...
export function ArchitectureSection() {
    ...
    return (
        <section ref={ref} className="py-16 lg:py-20 border-t">
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
                transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }}
                className="mx-auto max-w-5xl px-4 sm:px-6 md:px-8 grid grid-cols-1 md:grid-cols-[1fr_1.4fr] gap-6 md:gap-10 items-start"
            >
                {/* Text */}
