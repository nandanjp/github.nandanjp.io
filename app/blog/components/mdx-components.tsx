...
export const mdxComponents = {
    h1: ({ className, ...props }: HeadingProps) => (
        <h1
            className={cn(
                'mt-10 mb-4 scroll-m-20 font-hand text-3xl font-bold tracking-tight',
                className
            )}
            {...props}
        />
    ...
    h2: ({ className, ...props }: HeadingProps) => (
        <h2
            className={cn(
                'border-border mt-10 mb-4 scroll-m-20 border-b pb-2 font-hand text-2xl font-semibold tracking-tight',
                className
            )}
            {...props}
        />
    ...
    h3: ({ className, ...props }: HeadingProps) => (
        <h3
            className={cn(
                'mt-8 mb-3 scroll-m-20 font-hand text-xl font-semibold tracking-tight',
                className
            )}
            {...props}
        />
    ...
    h4: ({ className, ...props }: HeadingProps) => (
        <h4
            className={cn(
                'mt-6 mb-2 scroll-m-20 font-hand text-lg font-semibold',
                className
            )}
            {...props}
        />
    ...
    img: ({ src, alt, className }: { src?: string; alt?: string; className?: string }) => (
        <MdxImage src={src} alt={alt} className={className} />
    ),
