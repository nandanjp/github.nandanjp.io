...
const GRAPHICS_TOOLS = [
    { name: 'Three.js', iconPath: SI_THREEDOTJS, colors: { bg: 'bg-stone-100/80 dark:bg-stone-800/40', border: 'border-stone-200/70 dark:border-stone-700/40', text: 'text-stone-700 dark:text-stone-300', icon: 'text-stone-600 dark:text-stone-400' } },
    { name: 'WebGL', iconPath: SI_WEBGL, colors: { bg: 'bg-red-100/80 dark:bg-red-950/40', border: 'border-red-200/70 dark:border-red-800/40', text: 'text-red-700 dark:text-red-300', icon: 'text-red-600 dark:text-red-400' } },
    { name: 'GLSL', iconPath: 'M12 2L22 22H2L12 2Z', colors: { bg: 'bg-violet-100/80 dark:bg-violet-950/40', border: 'border-violet-200/70 dark:border-violet-800/40', text: 'text-violet-700 dark:text-violet-300', icon: 'text-violet-600 dark:text-violet-400' } },
    { name: 'R3F', iconPath: SI_REACT, colors: { bg: 'bg-cyan-100/80 dark:bg-cyan-950/40', border: 'border-cyan-200/70 dark:border-cyan-800/40', text: 'text-cyan-700 dark:text-cyan-300', icon: 'text-cyan-600 dark:text-cyan-400' } },
    { name: 'Blender', iconPath: SI_BLENDER, colors: { bg: 'bg-orange-100/80 dark:bg-orange-950/40', border: 'border-orange-200/70 dark:border-orange-800/40', text: 'text-orange-700 dark:text-orange-300', icon: 'text-orange-600 dark:text-orange-400' } }
] as const
            ...
            <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-6 px-4 sm:px-6 md:grid-cols-2 md:gap-10 md:px-8">
                ...
                >
                    ...
                    <div className="text-muted-foreground space-y-3 text-sm leading-relaxed sm:text-base">
                        {SITE.home.graphics.body.map((paragraph, paragraphIndex) => (
